    ...
    <group position={[-1.5, 1.56, -2]}>
      <Hotspot id="phone" yOffset={0.8}>
        ...
        <mesh position={[0, 0.08, 0]} castShadow>
          ...
          <meshStandardMaterial color={COLORS.phoneBody} roughness={0.5} flatShading />
        </mesh>
        ...
        <mesh position={[0, 0.24, 0]} castShadow>
          ...
          <meshStandardMaterial color="#111115" roughness={0.4} flatShading />
        </mesh>
        ...
        <mesh position={[0.5, 0.04, 0.1]} rotation-x={-Math.PI / 2} castShadow>
          ...
          <meshStandardMaterial color="#d4c9a8" roughness={0.9} flatShading />
        </mesh>

        {/* Envelope flap */}
        <mesh position={[0.5, 0.055, -0.01]} rotation-x={-0.3} castShadow>
          <boxGeometry args={[0.33, 0.01, 0.12]} />
          <meshStandardMaterial color="#c4b998" roughness={0.9} flatShading />
        </mesh>
      </Hotspot>
    </group>
  );
